...
<body>
            ...
            <nav>
                ...
                <ul>
                  <?php if($_SESSION['login']=="ADMINISTRATION"): ?>
                    ...
                    <li><a style="color:#4caf50" href="liste_reservation.php">Historiques</a></li>
    ...
    <table class="profil" color="red">
        <caption class="titretab">Consultation de mes Reservations</caption>
        <thead>
            <tr>
        ...
        <tbody>
            <?php 
        while($row = mysqli_fetch_array($mesreservation)) { ?>
            <tr>
